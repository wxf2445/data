...
{  
    ...
    private static String tessPath = "E:\\tools\\Tesseract\\Tesseract-OCR";  
    public static void main(String[] args)  
    {  
        try  
        {  
              
            File testDataDir = new File("E:\\tesseract\\testdata");  
...
//      System.out.println(cmd.toString());  
        ...
        return strB.toString().replaceAll("\\s*", "").replace("衰", "表");  
    }  
