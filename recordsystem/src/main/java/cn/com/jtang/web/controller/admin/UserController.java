...
public class UserController {
     ...
     * @return String
     */
    @RequiresPermissions(value = {"createuser"})
    @RequestMapping(
            value = "/create",
            method = RequestMethod.POST
    )
    ...
    public String userManage(@RequestParam(
        ...
        UserViewExample userExample = new UserViewExample();
        UserViewExample.Criteria criteria = userExample.createCriteria();
        ...
        model.addAttribute("userpages", new PageView(userService.selectViewByExample(userExample, pageObject)));
...
/*    @RequestMapping(
    ...
    public String  createTable(@RequestParam(
    	...
    	if(userService.createTable(ct)==1)
