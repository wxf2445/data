            ...
            <div class="rightbox_content">
                ...
                <div class="breadcrumbdiv">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <spring:message code="nav.menu.fonds" text="Fonds"/><spring:message
                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2><i class="glyphicon glyphicon-hdd"></i> <spring:message code="nav.menu.fonds"
                                                                                            text="Fonds"/><spring:message
                            ...
                            <div class="box-content">
                                ...
                                <div class="navbar-inner">
                                    <div class="navbar-form navbar-left">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <%-- <shiro:hasPermission name="createfonds">
                                                    <a class="createfonds btn btn-success" href="#">
                                                        <i class="glyphicon glyphicon-plus-sign"></i> <spring:message
                                                            code="btn.create" text="Create"/><spring:message code="nav.menu.fonds" text="Fonds"/>
                                                    </a>
                                                </shiro:hasPermission> --%>
                                            	<c:if test="${createfonds=='1' }">
	                                            	<a class="createfonds btn btn-success" href="#">
	                                                        <i class="glyphicon glyphicon-plus-sign"></i> <spring:message
	                                                            code="btn.create" text="Create"/><spring:message code="nav.menu.fonds" text="Fonds"/>
	                                                    </a>
                                    ...
                                    <c:url value="/fonds/manage" var="searchActoin">
                                    </c:url>
                                    <form:form modelAttribute="searchForm" action="${searchActoin}">
                                        ...
                                        <div class="navbar-form navbar-right" role="search">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <spring:message code="model.fonds.name" text="Search"
                                                                    var="placeholder_search"/>
                            ...
                            <span class="input-group-btn">
                              <button type="submit" class="btn btn-info"><i class="glyphicon glyphicon-search"></i>
                                ...
                                <c:set var="page" value="${fondspages.getPage() }"></c:set>
                                <div class="table-content">
                                    <table class="table table-striped table-bordered responsive">
                                        <thead>
                                        <tr>
                                            <th id="th_name"><spring:message code="model.fonds.name"
                                                                                          text="Name"/></th>
                                            <th id="th_fondsNo"><spring:message code="model.fonds.no"
                                                                                               text="Name"/></th>
                                            <th id="th_storeHouse"><spring:message code="model.fonds.storeHouse"
                                                                                               text="storeHouse"/></th>
                                            <th id="th_createtime"><spring:message
                                                    code="model.fonds.createtime" text="CreateTime"/></th>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <c:forEach var="fonds" items="${page.items }" varStatus="">
                                                    <tr id="${fonds.id }">
                                                        <td>${fonds.name }</td>
                                                        <td>${fonds.fondsno }</td>
                                                        <td>${fonds.storeHouse }</td>
                                                        <td>
                                                            <fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
                                                                            value="${fonds.createtime }"/>
                                                        </td>
                                                        <td class="">
                                                            <shiro:hasPermission name="deletefonds">
                                                                <a class="deletefonds btn btn-danger" title="删除全宗"><i
                                ...
                                <nav class="center">
                                    <ul class="pagination">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <li>
                                                    <a href="<c:url value="/fonds/manage?n=${n}&typeId=${typeId }&page=${page.previousPage()}&size=${page.getPageSize()}&sn=true"/>"><span>&laquo;</span></a>
                                                </li>
                                            </c:otherwise>
                                        </c:choose>
                                        <c:forEach var="p" items="${fondspages.showPages()}" varStatus="s">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <li>
                                                        <a href="<c:url value="/fonds/manage?n=${n}&typeId=${typeId }&page=${p}&size=${page.getPageSize()}&sn=true"/>"><span>${p}</span></a>
                                                    </li>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <li>
                                                    <a href="<c:url value="/fonds/manage?n=${n}&typeId=${typeId }&page=${page.nextPage()}&size=${page.getPageSize()}&sn=true"/>"><span>&raquo;</span></a>
                                                </li>
                                            </c:otherwise>
                                        </c:choose>
                                    </ul>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="box-content">
                ...
                <form:form modelAttribute="typeCreateForm" action="${createTypeAction}" class="form-horizontal" method="post"
                           role="form">
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label"><spring:message code="model.fonds.no"
                                                                              text="No"/></label>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label"><spring:message code="model.fonds.storeHouse"
                                                                              text="storeHouse"/></label>

                        <div class="col-sm-4">
                            <select id="shid" name="shid" class="form-control">
                                {{each storehouses}}
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".deletefonds").on("click", function (e) {
            ...
            $('#deleteFonds').tmpl(result).replaceAll($('#commonModal .modal-content'));
        ...
        $('.createfonds').on('click', function (e) {
            ...
            $.ajax({
                type:"POST",
                url:"<c:url value="/json/storehouse/all" />",
                data:{},
                success:function(result){
                    console.log(result);
                    $('#createFondsTemplate').tmpl(result).replaceAll($('#view .modal-content'));
                    $(".modal-dialog").width(800);
                    $('#view').modal('show');
                    ...
                    $(".createTypeButton").on('click', function (e) {
                    	if($("#view #typeCreateForm select[name=shid]").val()==null){
                            noty({
                                text: "暂无库房信息，请先添加库房！",
                                layout: "top",
                                type: "error",
                        ...
                        if ($('#view #typeCreateForm').valid()) {
                            $('#view #typeCreateForm').submit();
                        }
                    });
                }
            });
...
<script type="text/x-jquery-tmpl" id="deleteFonds">
	<div class="modal-content">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">×</button>
		<h4>温馨提示</h4>
	...
	<div class="modal-body">
        <div class="alert alert-info">提示：删除全宗，会删除全宗下的档案类型、档案所有数据，请谨慎操作！</div>
		<div class="box-content">
