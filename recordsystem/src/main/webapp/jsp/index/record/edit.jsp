                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <form:form modelAttribute="recordSearchForm" cssClass="form-horizontal"
                                                   action="${searchActoin}">
                                            <input name="isStore" type="hidden" value="0">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <a>
                                                        <input type="button" class="form-control" value="更多条件"
                                                ...
                                                <div class="col-md-2">
                                                    <div class="btn-group dropup">
                                                        ...
                                                        <div class="dropdown-menu noraiusmenu">
                                                            <a class="batchDelete btn btn-danger" title="<spring:message code="btn.export"
																				text="export" />" href="#">
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    function moreCondition() {
                                                        var li_3 = $("li[aria-level=3] .jstree-clicked");
                                                        if (li_3.length == 0)return;
                                                        /* var recordtypeid = li_3.parent().parent().parent().attr("id");
                                                         var type="_piece";
                                                         if(li_3.parent().hasClass("volume"))
                                                         type = "_volume"; */
                                                        $('#moreCondition').modal("show");
                                                    }


                                                </script>
                                                <div class="modal fade" id="moreCondition" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button"
                                                                        class="btn btn-primary sureCondition">
                                                                    确定
                                                                </button>
                                            ...
                                            <script type="text/html" id="oneMoreCondiction">
                                                {{each(i,v) tableFields}}
                                                {{if valueorindex==1}}
                                                <label class="col-sm-2 control-label">{{= name}}</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control" type="hidden" name="cols[{{= i}}].colid"
                                                           value="{{= fieldName}}">
                                                    <select name="cols[{{= i}}].colvalue" class="form-control">
                                                        {{each datas}}
                                                ...
                                                {{else}}
                                                {{if fieldName!='year' && fieldName!='deadline' && fieldName!='department'}}
                                                <label class="col-sm-2 control-label">{{= name}}</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control" type="hidden" name="cols[{{= i}}].colid"
                                                           value="{{= fieldName}}">
                                                    <input class="form-control" name="cols[{{= i}}].colvalue">
                                                </div>
                                                {{/if}}
                                                {{/if}}
                                                {{/each}}
...
--%>
                                        ...
                                        <c:url value="/json/record/batchdelete" var="batchdelete">
                                        </c:url>
                                        <form:form modelAttribute="modeForm" cssClass="form-horizontal"
                                                   action="${batchdelete}">
                                        ...
                                        <div class="table-content">
                                            <table class="table table-striped table-bordered responsive">
                                                <thead>
                                                <tr>
                                                    <th id="th_subject"><spring:message
                                                            code="model.record.subject"
                                                            text="Subject"/></th>
                                                    <th id="th_year"><spring:message
                                                            code="model.record.year"
                                                            text="year"/></th>
                                                    <th id="th_people"><spring:message
                                                            code="model.record.people"
                                                            text="people"/></th>
                                                    <th id="th_department"><spring:message
                                                            code="model.record.department"
                                                            text="department"/></th>
                                                    <th id="th_deadline"><spring:message
                                                            code="model.record.deadline"
                                                            text="deadline"/></th>
                                                    <th id="th_recordtype"><spring:message
                                                            code="model.record.recordtype"
                                                            text="recordtype"/></th>
                                                    <th id="th_createtime"><spring:message
                                                            code="model.record.createtime"
                                                            text="CreateTime"/></th>
                                                    <th class="actions w90"><spring:message
                                                            code="actions"
                                                            text="Actions"/></th>
                                                </tr>
                                                </thead>
...
<div class="modal fade" id="batchDeleteModal" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="box-content">
            	确定要删除<span class="content" style="color:#f00"></span>?
          	</div>
         </div>
         <div class="modal-footer">
...
<script type="text/html" id="recordListTemplate">
	...
	<h2>{{= records.title}}<span ><strong><b class="patterntext"></b></strong></span></h2>
    ...
    <div class="table-content" style="height:600px">
        <table class="table table-striped table-bordered responsive">
            ...
            <tr  recordid="{{= id}}" type='_record'>
                <td id="th_" ></th>
                <td class="operation">
                    <a href="#" class="btn btn-info volumeinneredit"><i class="glyphicon glyphicon-edit"></i></a>
                    <a href="#" class="btn btn-danger volumeinnerdelete"><i class="glyphicon glyphicon-trash"></i></a>
				</td>
				{{each fields}}
					{{if fieldname!="id"}}
...
<script type="text/html" id="buildVolumeSelectedTemplate">
    ...
    <div class="table-content selectedArea">
        <table class="table table-striped table-bordered responsive">
            <thead>
            <tr>
                <th id="th_select"><input type="checkbox" name="selectAll"></th>
        ...
        <div class="">
            ...
            <div class="navbar-inner">
                ...
                <form:form modelAttribute="buildRecordSearchForm" action="${searchActoin}">
                    ...
                    <form:hidden path="page"/>
                    <form:hidden path="size"/>
                    <%--<form:hidden path="isStore" value="0"/>--%>
                    <spring:message code="placeholder.start" text="Start"
                                    var="placeholder_start"/>
                    <spring:message code="placeholder.to" text="To" var="placeholder_to"/>
                    <spring:message code="placeholder.end" text="End"
    ...
    <div class="table-content">
        <table class="table table-striped table-bordered responsive">
            ...
            <tr>
                ...
                <th id="th_no">案卷号</th>
                {{/if}}
                <th id="th_sequenceNo"><spring:message code="model.record.sequenceNo"
                                                                          text="sequenceNo"/></th>
                <th id="th_year"><spring:message code="model.record.year"
                                                              text="year"/></th>
                <th id="th_department"><spring:message code="model.record.department"
            ...
            <tr id="{{= id}}">
                ...
                {{if category == 0}}
                <td><input type="checkbox" name="selectids" value="{{= id}}" data-subject="{{= subject}}"></td>
                <td class="recordNo">{{= recordno}}</td>
                {{else}}
                <td><input type="checkbox" name="selectids" value="{{= id}}" data-subject="{{= subject}}"></td>
                <td class="volumeNo">{{= volumeno}}</td>
                {{/if}}
                    <td class="sequenceNo">{{= sequenceNo}}</td>
                    <td class="year">{{= yearString}}</td>
                    <td class="department">{{= departmentString}}</td>
                    <td class="deadline">{{= deadlineString}}</td>
                ...
                <td class="center">
                    ...
                    <%--<a class="btn btn-success editPiece" title="编辑案件记录"><i class="glyphicon glyphicon-edit"></i></a>--%>
                    <a class="btn btn-success editRecord" title="编辑档案数据"><i class="glyphicon glyphicon-edit"></i></a>
                    <a class="btn btn-danger deletePiece" title="删除档案数据"><i class="glyphicon glyphicon-trash"></i></a>
                    <%--{{if tableid == null}}
                   ...
                   <a class="btn btn-success buildVolume" title="组卷"><i class="glyphicon glyphicon-inbox"></i></a>--%>
                    <a class="btn btn-success editVolume" title="编辑案卷记录"><i class="glyphicon glyphicon-edit"></i></a>
                    <a class="btn btn-success viewInnerRecord" title="查看卷内"><i
                            class="glyphicon glyphicon-inbox"></i></a>
                    <a class="btn btn-success uncoverVolume" title="撤销组卷"><i
                            class="glyphicon glyphicon-open"></i></a>
                    {{/if}}
                </td>
            </tr>
            {{/each}}
...
<script type="text/x-jquery-impl" id="createVolumeTemplate">
    <div class="box-content">
        <div class="alert alert-info">
            <b>档案号不填将由后台自动生成！</b>
        </div>

        <c:url var="editVolume" value="/json/recordvolume/edit"/>
        <form:form modelAttribute="volumeCreateForm" action="${editVolume}" class="form-horizontal"
                   method="post"
                   role="form">
    ...
    <div class="col-sm-4">
    <input id="subject" name="subject" class="form-control" value="{{= volumebase.subject}}" placeholder="{{= volumebase.subject}}">
    <label id="subject-error" class="control-label"></label>
    </div>
    ...
    <div class="col-sm-4">
    <input id="people" name="people" class="form-control" value="{{= volumebase.people}}" placeholder="{{= volumebase.people}}">
    <label id="people-error" class="control-label"></label>
    </div>
    ...
    <div class="form-group">
    <label class="col-sm-2 control-label"><b><spring:message code="model.record.recordNo"
                                                             text="RecordNo"/></b></label>

    <div class="col-sm-4">
    <input id="volumeno" name="volumeno" class="form-control" value="{{= volumebase.volumeno}}" placeholder="{{= volumebase.volumeno}}">
    <label id="volumeno-error" class="control-label"></label>
    </div>
    </div>
    ...
    <input class="form-control" name="customFields[{{= fieldName}}]" value="{{= volumebase[fieldName]}}">
    ...
    {{if volumebase[fieldName] == ivalue.id}}
    <option value="{{= ivalue.id}}" selected>{{= name}}</option>
    {{else}}
...
function showMusic(filePath){
    ...
    $(document).ready(function () {
        ...
        var currentCategory = "";
        $('#jstree').jstree();
        var showTables = function (url, category) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $(".batchDelete").on("click",function(){
                    	...
                    	var subjects = $("#modeForm").find("[name='selectids']:checked");
                    	
                    	for(var i=0;i<subjects.length;i++){
                    		content_array.push("“"+subjects.eq(i).data('subject')+"”");
                    	}
                    	
                    	$("#batchDeleteModal .content").html(content_array.join(","));
                    	$("#batchDeleteModal").modal('show');
                		$("#batchDeleteModal .btn-primary").off("click");
                    	$("#batchDeleteModal .btn-primary").on("click",function(){
                        	$("#batchDeleteModal").modal('hide');
                            $("#modeForm").find("[name='recordTypeId']").val(recordType);
                            $("#modeForm").find("[name='recordCategory']").val(category==0?'_piece':'_volume');
                        	$("#modeForm").ajaxSubmit({
                                dataType: "json",
                                type: "post",
                    ...
                    $(document).on("click", ".confirm", function () {
                        $("#commonModal2 #volumeCreateForm").submit();
                    });
                    $(".editVolume").on("click", function (e) {
                        var volumeId = $(this).closest("tr").attr("id");
                        $.ajax({
                            type: "POST",
                            url: "<c:url value="/json/recordvolume/getBase" />",
                            data: {volumeId: volumeId, fondsId: fondsId, recordTypeId: recordType},
                            success: function (result) {
                                result.volumeId = volumeId;
                                result.fondsId = fondsId;
                                result.mode = "0";
                                result.recordTypeId = recordType;
                                result.fonds = fondsName;
                                ...
                                $(".customarea [name^='custom[']").each(function () {
                    ...
                    var uncoverVolume = function (volumeId) {
                        $.ajax({
                            type: "POST",
                            url: '<c:url value="/json/record/uncoverVolume" />',
                            data: {volumeId: volumeId, fondsId: fondsId, recordTypeId: recordType},
                            success: function (result) {
                                console.log(result);
                                if (result == true) {
                    ...
                    $(".viewInnerRecord").on("click", function (e) {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                ...
                                $("#commonModal2").modal("show");
                                $(".volumeinneredit").on("click", function (e) {
                                    var recordid = $(this).closest("tr").attr("recordid");
                                    window.location.href = "<c:url value='/record/reimport'  />" + "?recordId=" + recordid + "&pattern=" + currentPattern + "&recordTypeId=" + recordType + "&fondsId=" + fondsId + "&recordTypeName=" + recordTypeName + "&fondsName=" + fondsName;
                                });
                                $(".volumeinnerdelete").on("click", function (e) {
                                    var recordid = $(this).closest("tr").attr("recordid");
                                    var result = {datetip: "确定要删除该档案吗？"};	
                                    $('#dateTipTemplate').tmpl(result).replaceAll($('#commonModal .modal-content'));
                                    $('#commonModal').modal("show");
                                    $('#commonModal').css("z-index","99999");

                                    $(".commonConfirm").on("click", function (e) {
                                    	$.ajax({
            	                            type: "POST",
            	                            url: '<c:url value="/json/record/delete" />',
            	                            data: {recordid: recordid, type:'_record', recordtypeid: recordType},
            	                            success: function (result) {
            	                            	if(result.status == 1){
            	                                    noty({
            	                                        text: "删除成功！",
                    ...
                    $(document).on("click", "#commonModal2 .modal-body .pointerimg", function () {
                        var recordid = $(this).closest("div").attr("recordid");
                        var type = $(this).closest("div").attr("type");
                        getDetail(recordid, type);
                    });

                    $(".deletePiece").on("click", function (e) {
                        var result = {datetip: "确定要删除该档案吗？"};	
                        $('#dateTipTemplate').tmpl(result).replaceAll($('#commonModal .modal-content'));
                        var recordid = $(this).closest("tr").attr("id");
                        $('#commonModal').modal("show");
                        ...
                        $(".commonConfirm").on("click", function (e) {
                        	$.ajax({
	                            type: "POST",
	                            url: '<c:url value="/json/record/delete" />',
	                            data: {recordid: recordid, type:'_piece', recordtypeid: recordType},
	                            success: function (result) {
	                            	if(result.status == 1){
	                                    noty({
	                                        text: "删除成功！",
        ...
        var setFormParam = function (context) {
        	//$("#moreCondition .box-content").html("");
...
/*             $.ajax({
                type: "POST",
                url: "<c:url value="/json/recordtype/getEditTableField"  />",
                data: {recordTypeId: recordType, type: "_volume"},
                success: function (result) {
                    $("#oneMoreCondiction").tmpl(result).appendTo($("#moreCondition .box-content"));
                    last_click_id = recordType + "_piece";
                }
            }); */
        }

        $(".sureCondition").on("click", function (e) {
            var this_ = $("li[aria-level=3] .jstree-clicked").parent();
            var recordTypeLi = $(this_).closest(".jstree-children").closest("[role=treeitem]");
            recordType = recordTypeLi.attr("id");
            recordTypeName = recordTypeLi.attr("title");
            var fondsLi = recordTypeLi.closest(".jstree-children").closest("[role=treeitem]");
            $("#rtId").val(recordType);
            ...
            fondsId = fondsLi.attr("id");
            fondsName = fondsLi.attr("title");
            if (this_.hasClass("volume")) {
                currentPattern = "0";
                currentUrl = "<c:url value="/json/recordvolume/manage" />";
                currentCategory = 1;
            } else {
                currentPattern = "1";
                currentUrl = "<c:url value="/json/piece/manage" />";
                currentCategory = 0;
            }
            showTables(currentUrl, currentCategory);
            $('#moreCondition').modal("hide");
        });
        $("#jstree").delegate(".volume a", "click", function (e) {
            setFormParam($(this));
            if (last_click_id != recordType + "_volume") {
                $("#moreCondition .box-content").html("");
                $.ajax({
                    type: "POST",
                    url: "<c:url value="/json/recordtype/getEditTableField"  />",
                    ...
                    success: function (result) {
                        $("#oneMoreCondiction").tmpl(result).appendTo($("#moreCondition .box-content"));
                        last_click_id = recordType + "_volume";
                    }
                });
            }
            currentUrl = "<c:url value="/json/recordvolume/manage" />";
            currentCategory = RCateGory.VOLUME;
            showTables(currentUrl, currentCategory);
        });

        $(document).delegate("[name='department'],[name='year'],[name='deadline']", "change", function (e) {
            if($("#jstree .volume").length==0)return;
            showTables(currentUrl,currentCategory);
        });
        $("#jstree").delegate(".record a", "click", function (e) {
            $("#moreCondition .box-content").html("");
            currentPattern = "0";
            setFormParam($(this));
            currentUrl = "<c:url value="/json/record/manage" />";
            currentCategory = RCateGory.TEMP;
            showTables(currentUrl, currentCategory);
        });
        if($("#jstree .volume").length>0){
            setFormParam($("#jstree .volume:first"));
        ...
        $("#jstree").delegate(".piece a", "click", function (e) {
            setFormParam($(this));
            if (last_click_id != recordType + "_piece") {
                $("#moreCondition .box-content").html("");
                currentPattern = "1";
                $.ajax({
                    type: "POST",
                    url: "<c:url value="/json/recordtype/getEditTableField"  />",
                    data: {recordTypeId: recordType, type: "_piece"},
                    success: function (result) {
                        $("#oneMoreCondiction").tmpl(result).appendTo($("#moreCondition .box-content"));
                        last_click_id = recordType + "_piece";
                    }
            ...
            currentUrl = "<c:url value="/json/piece/manage" />";
            currentCategory = RCateGory.PIECE;
            showTables(currentUrl, currentCategory);
        });
