    ...
    <div class="containercontent">
                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2><i class="glyphicon glyphicon-hdd"></i>   附件批量上传</h2>
                            </div>
        ...
        value="/json/record/batchupload"/>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" style="line-height: 40px;"><b>批量上传类型:</b></label>
                                        ...
                                        <div class="alert alert-info fileTable">
                                            <p>您共选择了<big><span class="fileNum black">0</span></big>个文件，</p>
                                            <p>文件名如下:</p>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <b><strong><span class="names black">无</span></strong></b>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        <span class="uploadtip" style="display: none;">请稍候，正在上传！<img style="width: 80px" src="<c:url value="/resources/images/loading2.gif"  />"></span>
                                        <span>上传进度:</span>
                                        <div class="progress">
...
<script>
    $(document).ready(function () {
        ...
        var batchUploadFile = function() {
            $(".uploadtip").show();
            $('.progress .progress-bar').attr('data-transitiongoal', 0).progressbar({display_text: 'fill'});
            $('.progress .progress-bar').attr('data-transitiongoal', 50).progressbar({display_text: 'fill'});
        ...
        $("#recorduploadform .batch-btn input[type='file']").on("change", function (e) {
            ...
            $(".fileTable .fileNum").text(files.length);
            $(".fileTable .names").text(names.join(","));
            $('.progress .progress-bar').attr('data-transitiongoal', 0).progressbar({display_text: 'fill'});
            $(".resulttable").empty();
        });
    });
