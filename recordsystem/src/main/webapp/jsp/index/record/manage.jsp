                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2><i class="glyphicon glyphicon-hdd"></i> 查看归档数据</h2>
                            </div>
    ...
    <div class="table-content">
        <table class="table table-striped table-bordered responsive">
            ...
            <tr>
                ...
                <th id="th_deadline"><spring:message code="model.record.deadline"
                                                          text="deadline"/></th>
                <th id="th_subject">{{= subject.name }}</th>
                <%--{{if isVolume == true}}
									            ...
									            <div class="col-md-9 pull-left fileContent" style="background:#fff;border-radius:5px;border: 1px #ccc solid;">
													...
													<div id="myTabContent" class="tab-content" style="height:94%">
													   <div class="tab-pane fade in active" id="home" style="height:90%">
											            	...
											            	<iframe name="openfile" id="openfileframe" height="100%" width="100%" frameborder="no" scrolling="no" ></iframe>
													   </div>
        ...
        var showTables = function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    result.isVolume = currentIsVolume;
