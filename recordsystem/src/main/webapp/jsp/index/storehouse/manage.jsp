            ...
            <div class="rightbox_content">
                ...
                <div class="breadcrumbdiv">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <spring:message code="nav.menu.storehouse" text="StoreHouse"/><spring:message
                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2><i class="glyphicon glyphicon-hdd"></i> <spring:message code="nav.menu.storehouse"
                                                                                            text="StoreHouse"/><spring:message
                            ...
                            <div class="box-content">
                                ...
                                <div class="navbar-inner">
                                    <div class="navbar-form navbar-left">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <shiro:hasPermission name="createstorehouse">
                                                    <a class="createstorehouse btn btn-success" href="#">
                                                        <i class="glyphicon glyphicon-plus-sign"></i> <spring:message
                                                            code="btn.create" text="Create"/><spring:message
                                                            code="nav.menu.storehouse"
                                                            text="StoreHouse"/>
                                                    </a>
                                                </shiro:hasPermission>
                                            </div>
                                    ...
                                    <%--<c:url value="/storehouse/manage" var="searchActoin">
                                    </c:url>
                                    <form:form modelAttribute="searchForm" action="${searchActoin}">
                                        ...
                                        <div class="navbar-form navbar-right" role="search">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <spring:message code="model.storehouse.name" text="Search"
                                                                    var="placeholder_search"/>
                            ...
                            <span class="input-group-btn">
                              <button type="submit" class="btn btn-info"><i class="glyphicon glyphicon-search"></i>
                                ...
                                <c:set var="page" value="${StoreHousepages.getPage() }"></c:set>
                                <div class="table-content">
                                    <table class="table table-striped table-bordered responsive">
                                        <thead>
                                        <tr>
                                            <th id="th_name" title="Name"><spring:message code="model.storehouse.name"
                                                                                          text="Name"/></th>
                                            <th id="th_location" title="Location"><spring:message
                                                    code="model.storehouse.location"
                                                    text="Name"/></th>
                                            <th id="th_cabnum" title="cabnum"><spring:message
                                                    code="model.storehouse.totalcabinet"
                                                    text="Name"/></th>
                                            <th id="th_floornum" title="floornum"><spring:message
                                                    code="model.storehouse.floorpercab"
                                                    text="Name"/></th>
                                            <th id="th_createtime" title="CreateTime"><spring:message
                                                    code="model.storehouse.createtime" text="CreateTime"/></th>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <c:forEach var="storehouse" items="${page.items }" varStatus="">
                                                    <tr id="${storehouse.id }">
                                                        <td class="name">${storehouse.name }</td>
                                                        <td>${storehouse.location }</td>
                                                        <td>${storehouse.totalcabinet }</td>
                                                        <td>${storehouse.floorpercab }</td>
                                                        <td>
                                                            <fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
                                                                            value="${storehouse.createtime }"/>
                                                        </td>

                                                        <td class="">
                                                            <a class="record btn btn-primary"
                                                               title=""><i
                                                                    class="glyphicon glyphicon-record"></i></a>
                                                            <a class="viewchart btn btn-info"
                                                               title=""><i
                                                                    class="glyphicon glyphicon-picture"></i></a>
                                                            <shiro:hasPermission name="editstorehouse">
                                                                <a class="editstorehouse btn btn-primary"
                                                                   title="编辑库房"><i
                                                                        class="glyphicon glyphicon-edit"></i></a>
                                                            </shiro:hasPermission>
                                                            <shiro:hasPermission name="deletestorehouse">
                                                                <a class="deletestorehouse btn btn-warning"
                                                                   title="删除库房"><i
                                ...
                                <nav class="center">
                                    <ul class="pagination">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <li>
                                                    <a href="<c:url value="/storehouse/manage?n=${n}&typeId=${typeId }&page=${page.previousPage()}&size=${page.getPageSize()}&sn=true"/>"><span>&laquo;</span></a>
                                                </li>
                                            </c:otherwise>
                                        </c:choose>
                                        <c:forEach var="p" items="${StoreHousepages.showPages()}" varStatus="s">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <li>
                                                        <a href="<c:url value="/storehouse/manage?n=${n}&typeId=${typeId }&page=${p}&size=${page.getPageSize()}&sn=true"/>"><span>${p}</span></a>
                                                    </li>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <li>
                                                    <a href="<c:url value="/storehouse/manage?n=${n}&typeId=${typeId }&page=${page.nextPage()}&size=${page.getPageSize()}&sn=true"/>"><span>&raquo;</span></a>
                                                </li>
                                            </c:otherwise>
                                        </c:choose>
                                    </ul>
...
<script src="<c:url value='/resources/js/echarts/echarts.js'/>"></script>
<script src="<c:url value='/resources/js/echarts/theme/shine.js'/>"></script>
...
<script type="text/html" id="userdeletetemplate">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="box-content">
                <p class="deletetip">是否确定要删除用户<span class="deletestorehousename"></span>信息？</p>
...
<script type="text/html" id="editHouseTemplate">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">×</button>
            <h4 class="optitle">编辑库房</h4>
        </div>
        <div class="modal-body">
            <div class="box-content">
                <c:url var="createTypeAction" value="/json/storehouse/edit"/>
                <form:form modelAttribute="storeHouse" name="storeHouse" action="${createTypeAction}"
                           class="form-horizontal" method="post"
                           role="form">
                    <input name="id" type="hidden" value="{{= storehouse.id}}">

                    <div class="form-group">
                        <label class="col-sm-2 control-label"><spring:message code="model.storehouse.name"
                                                                              text="Name"/></label>

                        <div class="col-sm-4">
                            <input id="name" name="name" class="form-control" placeholder="{{= storehouse.name}}">
                            <label id="name-error" class="control-label"></label>
                        </div>
                        <label class="col-sm-2 control-label"><spring:message code="model.storehouse.location"
                                                                              text="Name"/></label>

                        <div class="col-sm-4">
                            <input id="location" name="location" class="form-control"
                                   placeholder="{{= storehouse.location}}">
                            <label id="location-error" class="control-label"></label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><spring:message code="model.storehouse.totalcabinet"
                                                                              text="Name"/></label>

                        <div class="col-sm-4">
                            <input id="totalcabinet" name="totalcabinet" class="form-control"
                                   placeholder="{{= storehouse.totalcabinet}}">
                            <label id="totalcabinet-error" class="control-label"></label>
                        </div>
                        <label class="col-sm-2 control-label"><spring:message code="model.storehouse.floorpercab"
                                                                              text="Name"/></label>

                        <div class="col-sm-4">
                            <input id="floorpercab" name="floorpercab" class="form-control"
                                   placeholder="{{= storehouse.floorpercab}}">
                            <label id="floorpercab-error" class="control-label"></label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><spring:message code="model.storehouse.no"
                                                                              text="No"/></label>

                        <div class="col-sm-4">
                            <input id="no" name="no" class="form-control" placeholder="{{= storehouse.no}}">
                            <label id="no-error" class="control-label"></label>
                        </div>
                    </div>
                </form:form>
            </div>
        ...
        <div class="modal-footer">
            <a href="#" class="editSHButton btn btn-primary"><strong><i class="glyphicon glyphicon-share-alt"></i>
...
<script type="text/html" id="createStoreHouseTemplate">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">×</button>
            <h4 class="optitle">创建库房</h4>
        </div>
        <div class="modal-body">
            <div class="box-content">
                <c:url var="createTypeAction" value="/json/storehouse/create"/>
                <form:form modelAttribute="storeHouse" name="storeHouse" action="${createTypeAction}"
                           class="form-horizontal" method="post"
                           role="form">
                    <div class="form-group">
        ...
        <div class="modal-footer">
            <a href="#" class="createSHButton btn btn-primary"><strong><i class="glyphicon glyphicon-share-alt"></i>
                <span class="button1"><spring:message code="href.confirm" text="Confirm"/></span></strong></a>
            <a href="#" class="cancel btn btn-primary" data-dismiss="modal"><strong><i
                    class="glyphicon glyphicon-share-alt"></i> <span class="button2"><spring:message code="href.cancel"
                                                                                                     text="Cancel"/></span></strong></a>
...
<script type="text/html" id="recordTemplate">
    ...
    <div class="modal-body">
        <div class="box-content">
            <c:url value="/json/storehouse/recordinfo" var="recordInfoAction"/>
            <form method="post" id="recordInfoForm" action="${recordInfoAction}" role="form"
                  class="form-horizontal">
                <input id="stid" name="stid" type="hidden">

                <div class="form-group">
                    <label class="col-sm-2 control-label"><spring:message code="model.storehouse.temperature"
                                                                          text="temperature"/></label>

                    <div class="col-sm-4">
                        <input id="temperature" name="temperature" class="form-control">
                        <label id="temperature-error" class="control-label"></label>
                    </div>
                    <label class="col-sm-2 control-label"><spring:message code="model.storehouse.moisture"
                                                                          text="moisture"/></label>

                    <div class="col-sm-4">
                        <input id="moisture" name="moisture" class="form-control">
                        <label id="moisture-error" class="control-label"></label>
                    </div>
                </div>
            </form>
        </div>
...
<c:url var="getSensorDataUrl" value="/json/storehouse/sensordata"/>
...
<script src='<c:url value='/resources/js/storehouse/viewchart.js'/>'></script>
<script type="text/javascript">
    $(document).ready(function () {
        $(".record").on("click", function (e) {
            var storehouseid = $(this).closest("tr").attr("id");
            $('#recordTemplate').tmpl().replaceAll($('#commonModal2 .modal-body'));
            $('#commonModal2').modal("show");
            $("#commonModal2 .head").text("库房温湿度记录");
            $('#commonModal2 #recordInfoForm').validate(
                    {
                        ...
                        errorPlacement: function (error, element) {
                            console.log(error);
                            console.log(element);
                            error.replaceAll($("#" + $(element).attr("id") + "-error"));
                        },
                        rules: {
                            temperature: {
                                number: true,
            ...
            /*$("#recordInfoForm input").each(function () {
             $(this).rules("add", {
             number: true,
             maxlength: 8,
             required: true
            ...
            $("#recordInfoForm #stid").val(storehouseid);
            $(".confirm").on('click', function (e) {
                if ($('#recordInfoForm').valid()) {
                    $('#recordInfoForm').submit();
                }
            });
        });

        /* $(".deletestorehouse").on("click", function (e) {

        }); */
        $(".deletestorehouse").on("click", function (e) {
            var storehouseid = $(this).closest("tr").attr("id");
            var result = {datetip: "您确定要删除该库房吗吗？"};
            $('#dateTipTemplate').tmpl(result).replaceAll($('#commonModal .modal-content'));
            $('#commonModal').modal("show");

            $(".commonConfirm").on("click", function (e) {
                $.get("<c:url value="/json/storehouse/delete"  />", {storehouseid: storehouseid}, function (data, s, xh) {
                    console.log(data);
                    if (data.status == 1) {
                        noty({
                            text: "删除成功！",
        ...
        $('.createstorehouse').on('click', function (e) {
            e.preventDefault();
            $('#createStoreHouseTemplate').tmpl().replaceAll($('#view .modal-content'));
            $(".modal-dialog").width(800);
            $('#view').modal('show');
            $('#view #storeHouse').validate(
                    {
                        submitHandler: function (form) {
                            $(form).ajaxSubmit({
                                dataType: "json",
                        ...
                        rules: {
                            name: {
                                ...
                                required: true,
                                remote: {
                                    url: '<c:url value="/json/storehouse/checkname"/>',
                                    type: 'post',
                                    dataType: 'json',
                                    data: {
                                        name: function () {
                            ...
                            no: {
                                ...
                                required: true,
                                remote: {
                                    url: '<c:url value="/json/storehouse/checkno"/>',
                                    type: 'post',
                                    dataType: 'json',
                                    data: {
                                        no: function () {
            ...
            $(".createSHButton").on('click', function (e) {
                if ($('#storeHouse').valid()) {
                    $('#storeHouse').submit();
                }
            });
        ...
        $('.editstorehouse').on('click', function (e) {
            var id = $(this).parents("tr").attr("id");
            //var oldname = $(this).parents("tr").children('td .name').text();
            e.preventDefault();
            $.ajax({
                type: "get",
                url: "<c:url value="/json/storehouse/view"    />",
                data: {id: id},
                success: function (result) {
                    $('#editHouseTemplate').tmpl(result).replaceAll($('#view .modal-content'));
                    $(".modal-dialog").width(800);
                    $('#view').modal('show');
                    $('#view #storeHouse').validate(
                            {
                                ...
                                rules: {
                                    name: {
                                        ...
                                        required: true,
                                        remote: {
                                            url: '<c:url value="/json/storehouse/checkeditname"/>',
                                            type: 'post',
                                            dataType: 'json',
                                            data: {
                                                oname: result.storehouse.name,
                                                name: function () {
                                                    return $("[name='name']").val();
                                                }
                                            }
                                    ...
                                    no: {
                                        ...
                                        required: true,
                                        remote: {
                                            url: '<c:url value="/json/storehouse/checkeditno"/>',
                                            type: 'post',
                                            dataType: 'json',
                                            data: {
                                                ono: result.storehouse.no,
                                                no: function () {
                                                    return $("[name='no']").val();
                                                }
                                            }
                    ...
                    $(".editSHButton").on('click', function (e) {
                        if ($('#storeHouse').valid()) {
                            $('#storeHouse').submit();
                        }
                    });
