            ...
            <div class="rightbox_content">
                ...
                <div class="breadcrumbdiv">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <spring:message code="nav.menu.role" text="Role"/><spring:message code="breadcrumb.manage"
                                                                                              text="Manage"/>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="box-inner">
                            ...
                            <span class="input-group-btn">
                              <button type="submit" class="btn btn-info"><i class="glyphicon glyphicon-search"></i>
                                ...
                                <c:set var="page" value="${rolepages.getPage() }"></c:set>
                                    ...
                                    <table class="table table-striped table-bordered responsive">
                                        ...
                                        <tr>
                                            ...
                                            <th id="th_des"><spring:message
                                                    code="model.role.des" text="Des"/></th>
                                            ...
                                            <c:otherwise>
                                                <c:forEach var="role" items="${page.items }">
                                                    <tr id="${role.roleid }">
                                                        ...
                                                        <td class="">
                                                            <a class="viewPermission btn btn-primary" title="查看角色权限"><i
                                                                    class="glyphicon glyphicon-eye-open"></i></a>
                                                            <a class="modifyPermission btn btn-warning"
                                                               title="修改角色权限"><i
                                                                    class="glyphicon glyphicon-edit"></i></a>
                                                            <a class="deleterole btn btn-danger" title="删除角色">
                                ...
                                <nav class="center">
                                    <ul class="pagination">
                                        ...
                                        <c:forEach var="p" items="${rolepages.showPages()}" varStatus="s">
                                            <c:choose>
...
<script type="text/html" id="userdeletetemplate">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="box-content">
                <p class="deletetip">是否确定要删除用户<span class="deleterolename"></span>信息？</p>
...
<script type="text/html" id="createRoleTemplate">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">×</button>
            <h4 class="optitle">创建角色</h4>
        </div>
        <div class="modal-body">
            <div class="box-content">
                <c:url var="createRoleAction" value="/json/role/create"/>
                <form:form modelAttribute="roleCreateForm" action="${createRoleAction}" class="form-horizontal"
                           role="form">
                    <h3>角色基础信息</h3>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label"><spring:message code="model.role.code"
                                                                              text="Code"/></label>

                        <div class="col-sm-4">
                            <input id="code" name="code" class="form-control">
                            <label id="code-error" class="control-label"></label>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label"><spring:message code="model.role.des"
                                                                              text="Description"/></label>
                    ...
                    <div class="form-group">
                        ...
                        <span >注意：选中<big class="red">访问档案</big>将赋予该用户所有档案类型的此项权限！</span>
                    </div>
                    {{/if}}
                    {{/each}}
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="">
                ...
                <form id="modifyform" name="modifyform" action="<c:url value="/json/role/modifypermission"/>" >
...
<script type="text/x-jquery-impl" id="rolePermissionTemplate">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">×</button>
            <h4>查看角色拥有的权限</h4>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".viewPermission").on("click", function (e) {
            var roleid = $(this).closest("tr").attr("id");
            $.post("<c:url value="/json/permission/byrole"  />", {roleid: roleid}, function (result, status, xh) {
                console.log(result);
                $('#rolePermissionTemplate').tmpl(result).replaceAll($('#commonModal .modal-content'));
                $('#commonModal').modal("show");
            });
        });
        $(".modifyPermission").on("click", function (e) {
            var roleid = $(this).closest("tr").attr("id");
            $.post("<c:url value="/json/permission/modify"  />", {roleid: roleid}, function (result, status, xh) {
                console.log(result);
        ...
        $('.createrole').on('click', function (e) {
            ...
            $.post("<c:url value="/json/permission/all"/>", {
                ...
                console.log(result);
                $('#createRoleTemplate').tmpl(result).replaceAll($('#view .modal-content'));
                $(".modal-dialog").width(800);
                $(".optitle").text("创建角色");
                $(".button1").text("确定");
                $(".button2").text("取消");
