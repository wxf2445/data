                            ...
                            <div class="box-content">
                                ...
                                <%--target="fileiframe"--%> enctype="multipart/form-data">
                                    ...
                                    <fieldset>
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control" name="fonds">
                                                    <c:forEach var="fond" items="${fonds}">
                                                        <option value="${fond.id}" ${recordForm.fonds eq fond.id?'selected':''}>${fond.name}</option>
                                                    </c:forEach>
                                                </select>
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control" name="recordtype">
                                                    <c:forEach var="recordType" items="${recordTypes}">
                                                        <option value="${recordType.id}" ${recordForm.recordtype eq recordType.id?'selected':''}>${recordType.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control" name="department">
                                                    <c:forEach var="department" items="${departments}">
                                                        <option value="${department.id}" ${recordForm.department eq department.id?'selected':''}>${department.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            <label class="col-sm-2 control-label"><spring:message
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control" name="deadline">
                                                    <c:forEach var="deadline" items="${deadlines}">
                                                        <option value="${deadline.id}" ${recordForm.deadline eq deadline.id?'selected':''}>${deadline.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control" name="year">
                                                    <c:forEach var="year" items="${years}">
                                                        <option value="${year.id}" ${recordForm.year eq year.id?'selected':''}>${year.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            <label class="col-sm-2 control-label"><spring:message
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control" name="mode">
                                                    <option value="0" ${recordForm.mode eq "0"?'selected':''}>按卷
                                                    </option>
                                                    <option value="1" ${recordForm.mode eq "1"?'selected':''}>按件
                                                    </option>
                                                </select>
                                            </div>
                                            <%--<label class="col-sm-2 control-label"><spring:message
                                        ...
                                        <input type="hidden" id="isCustomExist"
                                               value="${recordForm.customFields ne null }">
                                        <input type="hidden" id="isCustomIndexExist"
                                               value="${recordForm.customIndexFields ne null }">
        ...
        {{each(i,value) customValueFields}}
            ...
            <div class="col-sm-3 " id="customFields_{{= fieldName}}">
                <input type="hidden" class="customFieldLength" value="{{= length}}">
                    <input class="form-control" name="customFields[{{= fieldName}}]" value="{{= customMap[fieldName]}}">
        ...
        <div class="col-sm-3 " id="customIndexFields_{{= fieldName}}">
            ...
            <select class="form-control" name="customIndexFields[{{= fieldName}}]" >
                {{each(j,ivalue) indexMap[fieldName]}}
                    {{if ivalue.id == customIndexMap[fieldName]}}
...
<script>
    ...
    $(document).ready(function () {
        ...
        ${customIndexFields};
         ...
         type: "POST",
         url: '
        <c:url value="/json/recordtype/getCustomField"  />',
         ...
         $(".customarea").empty();
         //result.hasCustomValue = jQuery.isEmptyObject(custommap);
         result.customMap =  custommap;
         // result.hasCustomIndexValue = jQuery.isEmptyObject(customIndexMap);
         result.customIndexMap =  customIndexMap;
         console.log(result);
