                              ...
                              <button type="submit" class="btn btn-info"><i class="glyphicon glyphicon-search"></i>
                                ...
                                <div class="table-content">
                                    <table class="table table-striped table-bordered responsive">
                                        <thead>
                                        <tr>
                                            <th id="th_name"><spring:message code="model.user.name"
                                                                                          text="Name"/></th>
                                            <th id="th_role"><spring:message
                                                    code="model.user.role" text="Role"/></th>
                                            <th id="th_des"><spring:message
                                                    code="model.user.description" text="Description"/></th>
                                            <th id="th_phone"><spring:message
                                                    code="model.user.cellphone" text="Phone"/></th>
                                            <th id="th_email"><spring:message
                                            ...
                                            <c:otherwise>
                                                <c:forEach var="user" items="${page.items }" varStatus="">
                                                    <tr id="${user.userid }">
                                                        ...
                                                        <td class="">
                                                                <%--<a class="viewTeamMember btn btn-primary" title="查看用户拥有组成员" onclick="create_table()"><i
                                                                        class="glyphicon glyphicon-eye-open"></i></a>--%>
                                                            <shiro:hasPermission name="accesscontrol">
                                                                <a class="accesscontrol btn btn-info" title="访问控制">
                                                                    <i class="glyphicon glyphicon-book"></i></a>
                                                            </shiro:hasPermission>
                                                            <shiro:hasPermission name="edituser">
                                                                <a class="edituser btn btn-primary" title="编辑用户">
                                                                    <i class="glyphicon glyphicon-edit"></i></a>
                                                            </shiro:hasPermission>
                                                            <shiro:hasPermission name="deleteuser">
                                                               <c:if test="${user.username ne 'superadmin'}">
                                                                   <a class="deleteuser btn btn-warning" title="删除用户">
...
<script type="text/html" id="accessControlTemplate">
    <div class="row">
        ...
        <div class="col-md-12">
            <div id="jstree">
                ...
                <ul>
                    {{each accesscontrol.fondss}}
                    <li class="jstree-open"
                        id="{{= fonds.id}}"
                        title="{{= fonds.name}}">{{= fonds.name}}
                        <ul>
                            {{each(i,v) recordTypes}}
                            <li class="jstree-open"
                                id="{{= v.id}}"
                                title="{{= v.name}}">{{= v.name}}
                                <ul>
                                    {{if selectedauths[v.id] != undefined}}
                                    {{each auths}}
                                            {{if isSelected(authorityid,selectedauths[v.id])||(hasARPermission == true && code == 'accessrecord')}}
                                            <li data-jstree='{"selected":true}' id="{{= v.id}}&{{= authorityid}}"
                                                class="leaf isSelected">
                                                {{= name}}
                                            </li>
                                            {{else}}
                                            <li id="{{= v.id}}&{{= authorityid}}"
                                                class="leaf notSelected">
                                                {{= name}}
                                            </li>
                                            {{/if}}
                                    ...
                                    {{else}}
                                    {{each auths}}
                                    {{if hasARPermission == true && code == 'accessrecord'}}
                                    <li data-jstree='{"selected":true}'  id="{{= v.id}}&{{= authorityid}}"
                                        class="leaf notSelected">
                                        {{= name}}
                                    </li>
...
<script type="text/javascript">
    function isSelected(id, ids) {
        var status = $.inArray(id, ids[0].split(",")) != -1;
        return status;
    }
</script>
            ...
            <div class="box-content">
                ...
                <form:form modelAttribute="createUserForm" action="${createUserAction}" class="form-horizontal"
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label"><spring:message code="model.user.phone"
                                                                              text="phone"/></label>

                        <div class="col-sm-3">
                            <p class="form-control-static">{{= phone}} </p>
                        </div>
                        <label id="phone-error" class="col-md-1"></label>
                    </div>
                    <div class="form-group">
            ...
            <div class="box-content">
                ...
                <form:form modelAttribute="userCreateForm" action="${editUserAction}" class="form-horizontal"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input id="tempusername" name="tempusername" class="form-control" value="{{= user.username}}" placeholder="{{= user.username}}">
                        ...
                        <div class="col-sm-4">
                            <select name="role" class="form-control">
                                {{each roles}}
                                <option value="{{= roleid}}" {{= user.roleid == roleid ? "selected":""}}>{{= name}}</option>
                                {{/each}}
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="phone" id="phone" class="form-control" value="{{= user.phone}}" placeholder="{{= user.phone}}">
                        ...
                        <div class="col-sm-4">
                            <input name="email" class="form-control" value="{{= user.email}}" placeholder="{{= user.email}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="description" class="form-control" placeholder="{{= user.description}}">{{= user.description}}</textarea>
...
<script type="text/html" id="createUserTemplate">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">×</button>
            <h4 class="optitle">创建用户</h4>
        </div>
        <div class="modal-body">
            <div class="box-content">
                <c:url var="createUserAction" value="/user/create"/>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.createuser').on('click', function (e) {
            e.preventDefault();
            $.post("<c:url value="/json/role/all"/>", {
                random: Math.random()
            }, function (result) {
                console.log(result);
                $('#createUserTemplate').tmpl(result).replaceAll($('#view .modal-content'));
                $(".modal-dialog").width(800);
                $(".button1").text("确定");
                $(".button2").text("取消");
                $('#view').modal('show');
        ...
        $('.accesscontrol').on('click', function (e) {
            var userid = $(this).closest("tr").attr("id");
            $.ajax({
                type: "get",
                url: "<c:url value="/json/permission/userrtcontrol"  />",
                data: {userid: userid},
                success: function (result) {
                    console.log(result);
                    $("#commonModal2 .modal-body").empty();
                    $("#commonModal2 .modal-header .head").text("访问控制设置");
                    $("#commonModal2 .modal-dialog").width(500);
                    $("#accessControlTemplate").tmpl(result).appendTo($("#commonModal2 .modal-body"));
                    $("#jstree").jstree({
                        "checkbox": {
                    ...
                    $("#commonModal2  .confirm").unbind("click").on("click", function (e) {
                        //var updateadditem = $(".notSelected.jstree-leaf:has(a.jstree-clicked)");
                        //var updateitem = $(".isSelected.jstree-leaf:not(:has(a.jstree-clicked))");
                        //var updateitem = $(".jstree-leaf .jstree-anchor.jstree-clicked");
                        var updateitem = $(".jstree-leaf[aria-selected='true']");
                        //var updateitem = $(".jstree-leaf");
                        //var updateitem2 = $(".isSelected.jstree-leaf[aria-selected='false']");
                        var addmap = {};
                        var updatemap = {};
                        $.each(result.recordTypes, function (i, v) {
                            updatemap[v] = "";
                        });
                        /*$.each(additem, function (i, v) {
                         var two = $(v).attr("id").split("_");
                         if (addmap[two[0]] == undefined) {
                         addmap[two[0]] = two[1];
                         } else {
                         addmap[two[0]] += "," + two[1];
                         }
                         });*/
                        $.each(updateitem, function (i, v) {
                            var two = $(v).attr("id").split("&");
                            if (updatemap[two[0]] != undefined) {
                                if (updatemap[two[0]].length == 0) {
                                    updatemap[two[0]] = two[1];
                                }
                                else {
                                    updatemap[two[0]] += "," + two[1];
                                }
                        ...
                        /*var upmap = "";
                         for (var prop in updatemap) {
                         if (updatemap.hasOwnProperty(prop)) {
                         // or if (Object.prototype.hasOwnProperty.call(obj,prop)) for safety...
                         if(upmap == ''){
                         upmap+=prop+"="+updatemap[prop];
                         }else{
                         upmap+="&"+prop+"="+updatemap[prop];
                         }
                         }
                         }*/
                        var map = {userid: userid, updatemap: updatemap};
                        $.ajax({
                            type: "post",
                            url: "<c:url value="/json/permission/userrtcontrol"  />",
