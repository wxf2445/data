        ...
        <div class="nav-canvas">
            ...
            <ul class="nav nav-pills nav-stacked main-menu">
                ...
                <shiro:hasAnyRoles name="SUPER ADMIN">
                    <li class="">
                        <a class="ajax-link" href='<c:url value="/admin/index"/>'>
                            <img alt="home" src="<c:url value='/resources/images/nav/housesetting.png' />">
                            <span> 主页</span>
                        </a>
                    </li>
                    ...
                    <li class="accordion"><a class="ajax-link" href="#"><img alt=""
                        ...
                        <ul class="nav nav-pills nav-stacked collapse">
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/archives/application" />"><img alt=""
                                                                                                src="<c:url value='/resources/images/nav/borrowapply.png' />"><span>	电子借阅申请

 </span></a>
                            </li>
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/archives/audit" />"><img alt=""
                                                                                          src="<c:url value='/resources/images/nav/waitapply.png' />"><span>等待审批
 </span></a>
                            </li>
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/archives/library" />"><img alt=""
                                                                                            src="<c:url value='/resources/images/nav/borrowapply.png' />"><span>实物借阅登记

 </span></a>
                            </li>
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/archives/notreturn" />"><img alt=""
                                                                                              src="<c:url value='/resources/images/nav/borrowedrecord.png' />"><span>待归还实体档案
 </span></a>
                            </li>
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/archives/record" />"><img alt=""
                    ...
                    <li class="accordion"><a class="ajax-link" href="#"><img alt=""
                        ...
                        <ul class="nav nav-pills nav-stacked collapse">
                            ...
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/record/recordupload" />"><img alt=""
                                                                                              src="<c:url value='/resources/images/nav/attachment.png' />"><span>批量上传著录信息</span></a>
                            </li>

                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/record/batchupload" />"><img alt=""
                                                                                              src="<c:url value='/resources/images/nav/attachment.png' />"><span>附件批量上传</span></a>
                            </li>

                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/record/batchexport" />"><img alt=""
                                                                                              src="<c:url value='/resources/images/nav/attachment.png' />"><span>附件批量导出</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="accordion"><a class="ajax-link" href="#"><img alt=""
                        ...
                        <ul class="nav nav-pills nav-stacked collapse">
                            ...
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/role/manage" />"><img alt=""
                                                                                       src="<c:url value='/resources/images/nav/permissionmanage.png' />"><span>角色管理
 </span></a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <li class=""><a class="ajax-link"
                                ...
                                <%--                             <li class=""><a class="ajax-link"
                                                                            href="<c:url value="/generaldata/manage" />"><img alt=""
                                                                                                                              src="<c:url value='/resources/images/nav/tree.png' />"><span>档案字段维护
                    ...
                    <li class="accordion"><a class="ajax-link" href="#"><img alt=""
                        ...
                        <ul class="nav nav-pills nav-stacked collapse">
                            ...
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/setPwd/manage" />"><img alt=""
                            ...
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/station/manage" />"><img alt=""
                                                                                          src="<c:url value='/resources/images/nav/siteinform.png' />"><span>站内通告
                                </span></a>
                            </li>
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/siteEmail/manage" />"><img alt=""
                            ...
                            <%--<li class=""><a class="ajax-link"
                                            href="<c:url value="/server/manage" />"><img alt=""
                                                                                         src="<c:url value='/resources/images/nav/serversetting.png' />"><span>服务器设置

                                </span></a>
                            </li>--%>
                            <li class=""><a class="ajax-link"
                                            href="<c:url value="/backup/all" />"><img alt=""
                ...
                <shiro:lacksRole name="SUPER ADMIN">
                    <li class="">
                        <a class="ajax-link" href='<c:url value="/admin/index"/>'>
                            <img alt="home" src="<c:url value='/resources/images/nav/housesetting.png' />">
                            <span> 主页</span>
